...
const translations = {
  en: {
    ...
    libraryTitle: "Drawing library",
    librarySubtitle: "Your offline DXF and DWG files",
    recentDrawings: "Recent drawings",
    filesAndFolders: "Files and folders",
    importDrawing: "Add drawing",
    newFolder: "New folder",
    folderName: "Folder name",
    emptyFolderTitle: "This folder is empty",
    emptyFolderDescription: "Add a DXF or DWG file, or create a folder.",
    rename: "Rename",
    copy: "Copy",
    move: "Move",
    delete: "Delete",
    ...
    mainFolder: "My drawings",
    deleteTitle: "Delete this item?",
    deleteDrawingDescription:
      "This drawing will be removed from the app library.",
    deleteFolderDescription:
      "This folder and everything inside it will be removed.",
    itemActions: "Item actions",
    invalidLibraryName:
      "Use a valid name without slash or control characters.",
    libraryNameExists: "An item with this name already exists.",
    invalidLibraryDestination: "This destination cannot be used.",
    libraryStorageFull:
      "There is not enough device storage to save this drawing.",
    libraryStorageUnavailable:
      "The drawing library is not available on this device.",
    libraryOperationFailed: "The operation could not be completed.",
  ...
  tr: {
    ...
    myDrawings: "Çizimlerim",
    libraryTitle: "Çizim Kitaplığı",
    librarySubtitle: "Çevrimdışı DXF ve DWG dosyalarınız",
    recentDrawings: "Son açılan çizimler",
    filesAndFolders: "Dosya ve klasörler",
    importDrawing: "Çizim ekle",
    newFolder: "Yeni klasör",
    folderName: "Klasör adı",
    emptyFolderTitle: "Bu klasör boş",
    emptyFolderDescription:
      "Bir DXF veya DWG dosyası ekleyin ya da klasör oluşturun.",
    ...
    save: "Kaydet",
    create: "Oluştur",
    chooseDestination: "Hedef klasörü seçin",
    mainFolder: "Çizimlerim",
    deleteTitle: "Bu öğe silinsin mi?",
    deleteDrawingDescription:
      "Bu çizim uygulama kitaplığından kaldırılacak.",
    deleteFolderDescription:
      "Bu klasör ve içindeki tüm dosyalar silinecek.",
    itemActions: "Öğe işlemleri",
    invalidLibraryName:
      "Eğik çizgi veya kontrol karakteri içermeyen geçerli bir ad kullanın.",
    libraryNameExists: "Bu adda başka bir öğe zaten var.",
    invalidLibraryDestination: "Bu hedef klasör kullanılamaz.",
    libraryStorageFull:
      "Bu çizimi kaydetmek için cihazda yeterli alan yok.",
    libraryStorageUnavailable:
      "Çizim kitaplığı bu cihazda kullanılamıyor.",
    libraryOperationFailed: "İşlem tamamlanamadı.",
    closeLibrary: "Kitaplığı kapat",
    back: "Geri",
    copied: "Öğe kopyalandı.",
    moved: "Öğe taşındı.",
    renamed: "Öğe yeniden adlandırıldı.",
    deleted: "Öğe silindi.",
